Public Class frmOnlineLabel
    ...
    Private Sub ToolStripButton1_Click(sender As Object, e As EventArgs) Handles ToolStripButton1.Click
        ...
        If msg = "Success" Then
            ...
            PreviewLabel(txtCustomer.Tag.ToString, lbl, CNO, txtSerialNo.Text)
            'PrintLabels(cboCust.Text.ToUpper, lbl, CNO)
        End If
    End Sub

    Private Sub PreviewLabel(ByVal Customer As String, ByVal LabelType As String, ByVal ControlNo As String, ByVal SerialNo As String)
    ...
    Private Sub PrintLabels(ByVal Customer As String, ByVal LabelType As String, ByVal ControlNo As String, ByVal SerialNo As String)
